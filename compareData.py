...
{'table_name': 'report',
 'params': {'report_id': {'type': 'Int(8)', 'is_null': 'n', 'is_only': 'y', 'is_index': 'y', 'is_null_ori': 'n', 'is_only_ori': 'y', 'is_index_ori': 'y', 'comment': '自增主键id，从10000开始自增。系统生成的报告编号。', 'default': '', checked:'no'},
            'result': {'type': 'tinyint(1)', 'is_null': 'n', 'is_only': 'n', 'is_index': 'n', 'is_null_ori': 'n', 'is_only_ori': 'y', 'is_index_ori': 'y', 'comment': '巡检记录是n存在异常；系统自动生成，巡检结果；0正常，1异常', 'default': '0', checked:'no'},
            'creator': {'type': 'varchar(16)', 'is_null': 'n', 'is_only': 'n', 'is_index': 'n', 'is_null_ori': 'n', 'is_only_ori': 'y', 'is_index_ori': 'y', 'comment': '创建人', 'default': '', checked:'no'},
            'create_time': {'type': 'timestamp', 'is_null': 'n', 'is_only': 'n', 'is_index': 'n', 'is_null_ori': 'n', 'is_only_ori': 'y', 'is_index_ori': 'y', 'comment': '创建时间', 'default': 'CURRENT_TIMESTAMP', checked:'no'},
            'updater': {'type': 'varchar(16)', 'is_null': 'n', 'is_only': 'n', 'is_index': 'n', 'is_null_ori': 'n', 'is_only_ori': 'y', 'is_index_ori': 'y', 'comment': '编辑人', 'default': '', checked:'no'},
            'update_time': {'type': 'timestamp', 'is_null': 'n', 'is_only': 'n', 'is_index': 'n', 'is_null_ori': 'n', 'is_only_ori': 'y', 'is_index_ori': 'y', 'comment': '编辑时间', 'default': 'CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP', checked:'no'}}
